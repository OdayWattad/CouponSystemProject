/**
 * It is responsible for design of the welcome page in the Dashboard 
 * 
 */
...
import { itemForText1, itemForText2, itemsForText3 } from '../../AdminComponents/AdminLayout/ItemsForText';
          ...
          <Fade cascade damping={0.2} duration={3000}>
            <Paper sx={{ mt: 4, ml: 6, width: "25em", height: "30em", backgroundColor: "rgba(18, 16, 16, 0.75)" }}>
              <Fade cascade damping={0.3}>
                ...
                <Typography sx={itemForText1}>Company Details</Typography>
                <Typography sx={itemForText2}> Here are the details of the account</Typography>
                <Typography sx={itemForText1}>Company Coupons</Typography>
                <Typography sx={itemForText2}> You have 3 options:</Typography>
                <Typography sx={itemsForText3}> Update, Delete, Filter CompanyCoupons</Typography>
                <Typography sx={itemForText1}>Add Coupon</Typography>
                <Typography sx={itemForText2}> You can add a coupon to the company</Typography>
              </Fade >
            </Paper>
          </Fade >
        </Box>

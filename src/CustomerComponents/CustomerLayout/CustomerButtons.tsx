/**
 * This component is responsible for the navBar at the left side in the customerDashboard. 
 */
...
const CustomerButtons: React.FC<Props> = (props) => {
  ...
  // This changes the action to "add" in the customerDashboard by lift-up
  const addHandler = () => {
    setAction("add");
  }

  // This changes the action to "showall" in the customerDashboard by lift-up
  const showAllHandler = () => {
    setAction("showAll");
  }

  // This changes the action to "details" in the customerDashboard by lift-up
  const detailsHandler = () => {
    setAction("details");
  }

  // This changes the action to "cart" in the customerDashboard by lift-up
  const cartHandler = () => {
    setAction("cart");
  }

...
In CouponSystemProject folder, there is one file:

CouponSystemStage2  (Java version) : (It uses mysql to be sure to download it)
...
Companies and Customers look them up in the sql database.

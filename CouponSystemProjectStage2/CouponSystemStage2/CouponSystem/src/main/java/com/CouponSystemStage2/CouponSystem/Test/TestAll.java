 ...
 */
package com.CouponSystemStage2.CouponSystem.Test;
...
import com.CouponSystemStage2.CouponSystem.Job.CouponExpirationDailyJob;
...
//            expirationThread.start();
            ...
            System.out.println("before update:" + companyService1.getCompanyCoupons().get(1));
            ...
            System.out.println( "After update:" + companyService1.getCompanyCoupons().get(1) );

            couponToUpdate.setCompany(adminService.getOneCompany(5));
            companyService1.updateCoupon(couponToUpdate);
            System.out.println( "Unsuccessful update:" + companyService1.getCompanyCoupons().get(1) );
            ...
            companyService1.deleteCoupon(companyService1.getCompanyCoupons().get(2).getId());
            ...
            System.out.println(TextColors.ANSI_CYAN + "***************************************************" + TextColors.ANSI_RESET);
            System.out.println(TextColors.ANSI_CYAN + "******************** Coupon Expiration Daily JOB **********************" + TextColors.ANSI_RESET);
